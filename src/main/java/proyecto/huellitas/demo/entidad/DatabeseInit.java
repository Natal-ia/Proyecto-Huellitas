...
public class DatabeseInit implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        mascotaRepository.save(new Mascota("Bonito", "Beagle", 11, 18, "ninguna",
                "https://i.pinimg.com/originals/1a/99/1c/1a991cd8128e376a350b1c76bfb4f12d.jpg", null, null));
        ...
        mascotaRepository.save(new Mascota("Rouvin", "Amphibolurus barbatus", 16, 3, "S-Series",
                "https://cdn.pixabay.com/photo/2014/12/10/05/50/english-bulldog-562723_1280.jpg", null, null));
        ...
        tratamientoRepository
                .save(new Tratamiento("Paracetamol", "Dolor de cabeza", "2021-01-01", "2021-01-10", "Dr. Juan", null));
        tratamientoRepository
                .save(new Tratamiento("Ibuprofeno", "Dolor de cabeza", "2021-01-01", "2021-01-10", "Dr. Juan", null));
        tratamientoRepository
                .save(new Tratamiento("Aspirina", "Dolor de cabeza", "2021-01-01", "2021-01-10", "Dr. Juan", null));
        tratamientoRepository
                .save(new Tratamiento("Paracetamol", "Dolor de cabeza", "2021-01-01", "2021-01-10", "Dr. Juan", null));
        tratamientoRepository
                .save(new Tratamiento("Ibuprofeno", "Dolor de cabeza", "2021-01-01", "2021-01-10", "Dr. Juan", null));
        ...
        tratamientoRepository
                .save(new Tratamiento("Paracetamol", "Dolor de cabeza", "2021-01-01", "2021-01-10", "Dr. Juan", null));
        tratamientoRepository.save(new Tratamiento("paspalum notatum pollen", "needs-based", "12/12/2021", "28/06/2023",
                "Ingemar Oppy", null));
        tratamientoRepository.save(
                new Tratamiento("Botrytis cinerea", "structure", "27/11/2020", "04/09/2023", "Renado Robshaw", null));
        tratamientoRepository
                .save(new Tratamiento("black-eyed pea", "contingency", "03/06/2020", "26/03/2023", "Alain Cay", null));
        tratamientoRepository.save(new Tratamiento("carbamazepine", "customer loyalty", "16/11/2020", "12/01/2024",
                "Averill Duggan", null));
        tratamientoRepository.save(
                new Tratamiento("Nitrogen", "Multi-layered", "25/12/2021", "02/04/2023", "Jedediah Gothup", null));
        tratamientoRepository
                .save(new Tratamiento("lisinopril", "didactic", "07/08/2020", "25/12/2023", "Sonnie Mintoft", null));
        tratamientoRepository.save(
                new Tratamiento("TITANIUM DIOXIDE", "analyzing", "06/07/2021", "17/02/2024", "Dolorita Blueman", null));
        tratamientoRepository
                .save(new Tratamiento("Propranolol", "paradigm", "16/02/2021", "05/03/2023", "Conni Vigneron", null));
        tratamientoRepository
                .save(new Tratamiento("Aspirin", "fresh-thinking", "05/02/2020", "11/01/2024", "Teressa Elton", null));
        tratamientoRepository.save(new Tratamiento("Trichophyton Mixture", "asynchronous", "30/09/2021", "16/07/2023",
                "Fowler Woolway", null));
        tratamientoRepository.save(new Tratamiento("California Valley White Oak", "composite", "27/03/2021",
                "18/01/2024", "Timotheus Blackleech", null));
        tratamientoRepository
                .save(new Tratamiento("Nifedipine", "software", "17/04/2021", "13/12/2023", "Emmey Yanyshev", null));
        tratamientoRepository.save(
                new Tratamiento("Nicotine polacrilex", "Up-sized", "29/07/2020", "06/01/2024", "Cass Galvan", null));
        tratamientoRepository
                .save(new Tratamiento("MUCOR PLUMBEUS", "function", "19/05/2020", "10/11/2023", "Maggy Czadla", null));
        tratamientoRepository.save(new Tratamiento("Octinoxate and Avobenzone", "website", "01/12/2021", "23/11/2023",
                "Klara Rowan", null));
        tratamientoRepository.save(new Tratamiento("mechlorethamine hydrochloride", "Expanded", "15/03/2020",
                "02/06/2023", "Hobey Mannix", null));
        tratamientoRepository.save(new Tratamiento("Chlorhexidine gluconate and Propylene Glycol", "paradigm",
                "07/09/2021", "24/03/2023", "Madonna Barde", null));
        tratamientoRepository.save(new Tratamiento("OCTINOXATE and TITANIUM DIOXIDE", "5th generation", "15/12/2020",
                "16/11/2023", "Leah Ferryman", null));
        tratamientoRepository.save(new Tratamiento("Avobenzone, Homosalate, Octisalate, Octocrylene, Oxybenzone",
                "instruction set", "07/08/2020", "11/01/2024", "Marena Sully", null));
        tratamientoRepository.save(
                new Tratamiento("Menthol", "data-warehouse", "04/11/2021", "09/09/2023", "Kristel Yeardley", null));
        tratamientoRepository.save(
                new Tratamiento("thiothixene", "collaboration", "07/12/2021", "14/08/2023", "Sidnee McConnell", null));
        tratamientoRepository.save(new Tratamiento("Camphor,Menthol,Methyl Salicylate", "next generation", "31/03/2020",
                "25/08/2023", "Saw Gilogly", null));
        tratamientoRepository
                .save(new Tratamiento("DIPYRIDAMOLE", "24/7", "04/02/2021", "16/02/2024", "Renae Freeman", null));
        tratamientoRepository.save(new Tratamiento(
                "Chimaphila umbellata, Pituitarinum gland, Uva-ursi, Orchitinum, Prostate, Sarsaparilla,",
                "orchestration", "12/11/2020", "12/02/2024", "Thatch Flecknoe", null));
        tratamientoRepository.save(new Tratamiento("Sodium Bicarbonate", "optimizing", "03/04/2020", "13/08/2023",
                "Christye Pegrum", null));
        tratamientoRepository.save(
                new Tratamiento("fondaparinux sodium", "motivating", "11/05/2021", "08/09/2023", "Flossi Boys", null));
        tratamientoRepository.save(new Tratamiento("Octinoxate and Titanium Dioxide", "service-desk", "24/07/2020",
                "13/04/2023", "Hannie McKenny", null));
        tratamientoRepository.save(new Tratamiento("AVOBENZONE, OCTINOXATE, OCTISALATE", "scalable", "25/01/2020",
                "16/08/2023", "Felice Drust", null));
        tratamientoRepository.save(new Tratamiento("rocuronium bromide", "Down-sized", "07/02/2020", "06/02/2024",
                "Gavin Middlehurst", null));
        tratamientoRepository.save(
                new Tratamiento("MORPHINE SULFATE", "grid-enabled", "29/06/2020", "12/10/2023", "Tanner Lucy", null));
        tratamientoRepository.save(new Tratamiento("bisoprolol fumarate and hydrochlorothiazide", "encryption",
                "04/02/2021", "06/04/2023", "Stephannie Phillipps", null));
        tratamientoRepository.save(new Tratamiento("Camphor, Menthol, Methyl Salicylate", "uniform", "27/12/2021",
                "22/03/2023", "Gunter Bilby", null));
        tratamientoRepository.save(
                new Tratamiento("BENZOYL PEROXIDE", "capacity", "12/03/2020", "07/12/2023", "Prentiss Skipper", null));
        tratamientoRepository.save(new Tratamiento("Diphenhydramine Hydrochloride", "attitude-oriented", "16/11/2020",
                "09/10/2023", "Ivonne Lauritzen", null));
        tratamientoRepository.save(new Tratamiento("hydromorphone hydrochloride", "Profit-focused", "21/02/2021",
                "14/04/2023", "Valera McKinnell", null));
        tratamientoRepository.save(new Tratamiento("oxycodone hydrochloride", "Grass-roots", "06/01/2021", "26/04/2023",
                "Lebbie Waterhouse", null));
        tratamientoRepository
                .save(new Tratamiento("cefixime", "Assimilated", "12/03/2020", "15/02/2024", "Regan Dibbe", null));
        tratamientoRepository.save(new Tratamiento("Zinc Acetate and Zinc Gluconate", "optimal", "01/04/2020",
                "20/04/2023", "Delia Kinneally", null));
        tratamientoRepository.save(new Tratamiento("zinc acetate and zinc gluconate", "middleware", "01/09/2021",
                "08/08/2023", "Raphael Labat", null));
        tratamientoRepository.save(new Tratamiento("SACCHAROMYCES CEREVISIAE", "background", "25/02/2021", "25/08/2023",
                "Bram Korfmann", null));
        tratamientoRepository.save(new Tratamiento("benzalkonium chloride", "optimizing", "28/08/2021", "23/03/2023",
                "Quintus Fortnon", null));
        tratamientoRepository.save(
                new Tratamiento("Alcohol", "Graphic Interface", "16/05/2020", "20/02/2024", "Josefa Gillanders", null));
        tratamientoRepository.save(new Tratamiento(
                "APIS MELLIFERA, GALPHIMIA GLAUCA WHOLE, POTASSIUM DICHROMATE, TEUCRIUM MARUM TOP, and VERBASCUM DENSIFLORUM FLOWERING TOP",
                "high-level", "05/08/2020", "26/05/2023", "Gray Vashchenko", null));
        tratamientoRepository
                .save(new Tratamiento("Phenol", "benchmark", "19/05/2020", "18/06/2023", "Nicolina Nys", null));
        tratamientoRepository.save(new Tratamiento("flurazepam hydrochloride", "challenge", "05/07/2021", "20/11/2023",
                "Kai Brace", null));
        tratamientoRepository.save(new Tratamiento("Octinoxate and Oxybenzone", "Innovative", "05/10/2021",
                "14/10/2023", "Freeland Held", null));
        tratamientoRepository
                .save(new Tratamiento("Folic Acid", "capacity", "12/04/2021", "29/11/2023", "Mechelle Adey", null));
        tratamientoRepository.save(new Tratamiento("amoxicillin and clavulanate potassium", "local", "02/10/2020",
                "27/05/2023", "Tova Coger", null));
        tratamientoRepository
                .save(new Tratamiento("Water", "eco-centric", "17/01/2020", "06/10/2023", "Ernestus Konert", null));
        tratamientoRepository
                .save(new Tratamiento("Loratadine", "application", "29/06/2021", "01/03/2024", "Fidelio Pyburn", null));
        tratamientoRepository.save(new Tratamiento("Diphenhydramine Hydrochloride", "local", "28/05/2020", "31/05/2023",
                "Florina Keune", null));
        tratamientoRepository.save(new Tratamiento(
                ...
                "Balanced", "28/06/2020", "28/03/2023", "Joya Rubertelli", null));
        tratamientoRepository.save(new Tratamiento("Diphenhydramine HCl", "ability", "03/06/2021", "21/12/2023",
                "Angele Tregoning", null));
        tratamientoRepository.save(new Tratamiento("Ibuprofen", "next generation", "23/10/2021", "27/09/2023",
                "Kristopher Riggoll", null));
        tratamientoRepository.save(
                new Tratamiento("Silver Sulfadiazine", "success", "14/02/2020", "21/01/2024", "Kristy Ambrus", null));
        tratamientoRepository
                .save(new Tratamiento("Prednisone", "Synergized", "05/09/2020", "25/10/2023", "Ruddie Twatt", null));
        tratamientoRepository.save(new Tratamiento("diltiazem hydrochloride", "challenge", "17/02/2020", "25/05/2023",
                "Corrie Wiltshaw", null));
        tratamientoRepository.save(new Tratamiento("Rimantadine Hydrochloride", "Optional", "09/12/2021", "25/02/2024",
                "Florrie Cossor", null));
        tratamientoRepository.save(new Tratamiento("3 in 1 Antibacterial Hair and Body Wash", "client-server",
                "13/12/2021", "27/11/2023", "Burl Lavall", null));
        tratamientoRepository.save(new Tratamiento("Avobenzone, Homosalate, Octisalate, Octocrylene, and Oxybenzone",
                "Virtual", "31/10/2021", "25/07/2023", "Flor McKirdy", null));
        tratamientoRepository
                .save(new Tratamiento("Tolnaftate", "Function-based", "19/05/2020", "17/09/2023", "Myra Rives", null));
        tratamientoRepository.save(
                new Tratamiento("Sodium Fluoride", "Managed", "21/03/2020", "19/11/2023", "Terri Shucksmith", null));
        tratamientoRepository
                .save(new Tratamiento("Almond", "initiative", "27/12/2020", "30/12/2023", "Konstance Trevance", null));
        tratamientoRepository.save(
                new Tratamiento("ETHYL ALCOHOL", "motivating", "30/07/2020", "24/09/2023", "Morgana Manueli", null));
